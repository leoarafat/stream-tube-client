...
<footer>
  <div class="bg-gray-50 dark:bg-gray-800 pt-8 md:pt-20">
    <div class="container m-auto space-y-8 px-6 text-gray-600 dark:text-gray-300 md:px-12 lg:px-20">
      <div>
        <div
          class="mb-6 items-center justify-between gap-6 py-6 sm:flex md:mb-16 md:space-y-6 md:py-0"
        >
          <img width="100" height="42" src="images/logo.svg" alt="logo tailus" class="w-32" />
          <div
          ...
          <div class="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
            ...
            <div class="col-span-2 sm:col-span-3 md:col-span-2">
              ...
              <ul class="mt-4 list-inside space-y-4">
                ...
                <li>
                  <a href="mailto:meschacirung@gmail.com" class="transition hover:text-primary"
                    >contact@tailus.com</a
                  >
                </li>
                <li>
                  <form action="">
                    <label for="newsletter" class="text-lg text-gray-700 dark:text-gray-200"
                    ...
                    <div class="relative mt-4">
                      <input
                        ...
                        class="invalid:outline-none placeholder-gray-600 dark:placeholder-white rounded-3xl w-full bg-gray-100 dark:bg-gray-900 px-4 py-3 ring-1 ring-gray-200 dark:ring-gray-700 invalid:ring-red-400"
                      />
                      <button
                        type="submit"
                        title="Submit"
                      ...
                      >
                        <span class="font-semibold text-gray-900"> Send </span>
                      </button>
                    </div>
                  </form>
                </li>
