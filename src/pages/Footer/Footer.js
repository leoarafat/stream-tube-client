            ...
            <div>
              <div class="mb-6 items-center justify-between gap-6 py-6 sm:flex md:mb-16 md:space-y-6 md:py-0">
                <div class="mt-6 flex flex-col-reverse flex-wrap gap-6 sm:mt-0 sm:flex-row sm:items-center">
                  <select
                    name="langage"
                    id="langae"
                    class="w-full rounded-xl px-4 py-2 sm:w-max"
                  >
              ...
              <div>
                <div class="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
                  <div>
                    <h6 class="text-lg font-medium dark:text-gray-200">
                      Categories
                    </h6>
                        ...
                        <form action="">
                          ...
                          <div class="relative mt-4">
                            <input
                              ...
                              class="invalid:outline-none placeholder-gray-600 dark:placeholder-white rounded-3xl w-full 0 px-4 py-3 ring-1 ring-gray-200 dark:ring-gray-700 invalid:ring-red-400"
                            />
                            <button
                              type="submit"
                              title="Submit"
                ...
                <div class="flex justify-between border-t border-cyan-800 py-8 text-gray-200">
                  <span>
                    &copy; streamTube 2003 - <span id="year"></span>
                  </span>
